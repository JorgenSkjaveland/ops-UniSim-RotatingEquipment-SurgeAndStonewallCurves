...
def main():
    ...
    SurgeLine = CurveFunctions.GetSurgeCurve(margin_Surge, Curves, Equipment_Name, Head_Unit, Flow_Unit)
    
    StoneWallLine = CurveFunctions.GetStoneWallCurve(margin_StoneWall, Curves, Equipment_Name, Head_Unit, Flow_Unit)
